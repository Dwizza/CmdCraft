...
?>
    ...
    <div class='w-[500px] rounded-md p-10 mt-10 m-auto' style="background: linear-gradient(80deg,rgb(209, 18, 18),rgb(171, 2, 5),rgb(48, 0, 0))">
    <form class="flex flex-col items-center gap-5 mt-5" action="" method="POST">
        ...
        <button class="px-4 py-2 w-20 text-white rounded-lg bg-red-500 hover:bg-red-900" type="submit" name="btnSubmit">Edit</button>
    </form>
</div>
